...
export default function ContentBlockCallout(props: { block: SupernovaTypes.DocumentationPageBlockCallout }) {
  ...
  switch (props.block.calloutType) {
    case SupernovaTypes.CalloutType.info:
      alertClass = "alert-info"
      break
    case SupernovaTypes.CalloutType.success:
      alertClass = "alert-success"
      break
    case SupernovaTypes.CalloutType.warning:
      alertClass = "alert-warning"
      break
    case SupernovaTypes.CalloutType.error:
