...
export default function ContentBlockLink(props: { block: SupernovaTypes.DocumentationPageBlockLink }) {
  ...
  return (
    <a href={props.block.url} target="_blank">
      <div className="embed-url row">
        ...
        {props.block.thumbnailUrl ? (
          <div
            className="preview col-4"
            style={{ background: `url(${props.block.thumbnailUrl})`, backgroundSize: "cover", backgroundPosition: "center" }}
          ></div>
        ) : null}
      </div>
    </a>
